# reversi_oop.py
# Console Reversi (Othello) in Python: PvP and AI (Random / Greedy / Minimax)
...
def choose_difficulty():
    ...
    print("  1) Easy   — random move (JR Smith)")
    print("  2) Medium — greedy (Offer Yannay)")
    print("  3) Hard   — minimax (LeBron James)")
    while True:
        s = input("Enter 1/2/3: ").strip()
        if s == '1':
